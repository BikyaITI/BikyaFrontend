...
@Component({
  ...
  template: `
    <div class="container mt-4">
      ...
      <div *ngIf="!isLoading">
        <div class="row">
          <div class="col-12" *ngFor="let order of getFilteredOrders()">
            <div class="card mb-4 shadow-sm order-card">
              ...
              <div class="card-body">
                    ...
                    <div class="d-flex align-items-center">
                      ...
                      <div class="flex-grow-1">
                        ...
                        <p class="text-muted mb-1">
                          Sold by: {{order.seller?.fullName}}
                        </p>
                        <div class="d-flex align-items-center">
                          <span class="text-primary fw-bold me-3">
                            \${{order.product?.price | number:'1.2-2'}}
                          </span>
                ...
                <!-- Shipping Info -->
                <div class="mt-3 pt-3 border-top" *ngIf="order.shippingInfo">
                  <div class="row">
                    <div class="col-md-6">
                      ...
                      <p class="mb-0">{{order.shippingInfo.city}}, {{order.shippingInfo.postalCode}}</p>
                    </div>
                    <div class="col-md-6" *ngIf="order.shippingInfo.trackingNumber">
                      <h6 class="text-muted mb-2">
                        <i class="bi bi-truck"></i> Tracking Number
                      </h6>
                      <p class="mb-0 font-monospace">{{order.shippingInfo.trackingNumber}}</p>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <!-- Empty State -->
      <div *ngIf="!isLoading && getFilteredOrders().length === 0" class="text-center py-5">
        <div class="empty-state">
          <i class="bi bi-receipt display-1 text-muted mb-3"></i>
          <h3>No orders found</h3>
          <p class="text-muted mb-4">
            <span *ngIf="activeTab === 'all'">You haven't placed any orders yet.</span>
            <span *ngIf="activeTab === 'pending'">You don't have any pending orders.</span>
            <span *ngIf="activeTab === 'shipped'">You don't have any shipped orders.</span>
            <span *ngIf="activeTab === 'delivered'">You don't have any delivered orders.</span>
          </p>
          <a routerLink="/products" class="btn btn-primary">
              ...
              <div class="col-md-6">
                ...
                <table class="table table-sm">
                  ...
                  <tr>
                    ...
                    <td>{{selectedOrder.createdAt | date:'medium'}}</td>
                  </tr>
                  <tr>
                    <td><strong>Total Amount:</strong></td>
                    <td class="text-primary fw-bold">\${{selectedOrder.totalAmount | number:'1.2-2'}}</td>
                  </tr>
                </table>
              </div>
              <div class="col-md-6">
                ...
                <div class="d-flex align-items-center">
                  ...
                  <div>
                    <h6 class="mb-0">{{selectedOrder.seller?.fullName}}</h6>
                    <small class="text-muted">{{selectedOrder.seller?.email}}</small>
                  </div>
                </div>
              </div>
            </div>
